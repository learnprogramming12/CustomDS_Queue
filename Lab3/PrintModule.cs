...
namespace Lab3
{
    internal class PrintModule
    {
        ...
        public static EnumResult Print(Queue<int> queue/*EnumDataStructrue enumCurrentDataStructure, DataType dataStructure*/)
        {
            if (queue.Count == 0)
            {
                Console.WriteLine("Warning: The queue is empty.");
            ...
            while (true)
            {
                ...
                PrintFormat.Print(queue, enumFormat);
            }
        }
    }
}
